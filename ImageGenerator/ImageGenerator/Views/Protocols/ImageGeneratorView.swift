...
extension ImageGeneratorView {
    ...
    func checkIfFolderExists(folderPath: String) -> Bool {
        ...
        let result = fileManager.fileExists(atPath: folderPath, isDirectory: &isDir) && isDir.boolValue
